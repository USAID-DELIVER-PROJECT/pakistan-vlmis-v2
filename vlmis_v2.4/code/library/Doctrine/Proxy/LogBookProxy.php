...
class LogBookProxy extends \LogBook implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setRefferTo($refferTo);
    }

    public function getRefferTo()
    {
        $this->__load();
        return parent::getRefferTo();
    }
    ...
    {
        return array('__isInitialized__', 'pkId', 'name', 'fatherName', 'age', 'contact', 'address', 'vaccinationDate', 'refferTo', 'reportingStartDate', 'remarks', 'createdDate', 'modifiedDate', 'district', 'unionCouncil', 'warehouse', 'createdBy');
    }
