 ...
 */
class VvmTypesProxy extends \VvmTypes implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setVvmTypeName($vvmTypeName);
    }

    public function getVvmTypeName()
    {
        $this->__load();
        return parent::getVvmTypeName();
    }
    ...
    {
        return array('__isInitialized__', 'pkId', 'vvmTypeName', 'status', 'createdDate', 'modifiedDate', 'itemPackSize', 'createdBy', 'modifiedBy');
    }
