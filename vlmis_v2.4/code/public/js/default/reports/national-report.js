    ...
    function doInitGrid() {
        ...
        mygrid.attachHeader("<span title='Product Name'>Product</span>,<span title='Product Consumption'>Consumption (Doses)</span>,<span title='Average Monthly Consumption'>AMC (Doses)</span>,<span title='Product On Hand'>On Hand (Doses)</span>,<span title='Month of Scale'>MOS</span>,#cspan");
        ...
        mygrid.init();
        mygrid.loadXML(appName+"/xml/national_report.xml");
    }
