...
/**
 * Doctrine\Extensions Vendor Specific DQL Query Features
 *
 ...
 *
 * $query = $qb->getQuery();
 * $query->setHint(Doctrine\ORM\Query::HINT_CUSTOM_OUTPUT_WALKER, 'Webges\Doctrine\Extensions\Query\SortableNullsWalker');
 * $query->setHint("sortableNulls.fields", array(
 * 				"p.firstname" => Webges\Doctrine\Extensions\Query\SortableNullsWalker::NULLS_FIRST,
 * 				"p.lastname"  => Webges\Doctrine\Extensions\Query\SortableNullsWalker::NULLS_LAST,
 * 				"p.basedOnPerson.id" => Webges\Doctrine\Extensions\Query\SortableNullsWalker::NULLS_LAST
 * 			));
 *
...
namespace Doctrine\Extensions\Query;
