 ...
 */
class CampaignTypesProxy extends \CampaignTypes implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setCamapignTypeName($camapignTypeName);
    }

    public function getCamapignTypeName()
    {
        $this->__load();
        return parent::getCamapignTypeName();
    }
    ...
    {
        return array('__isInitialized__', 'pkId', 'camapignTypeName', 'listRank', 'createdDate', 'modifiedDate', 'createdBy', 'modifiedBy');
    }
