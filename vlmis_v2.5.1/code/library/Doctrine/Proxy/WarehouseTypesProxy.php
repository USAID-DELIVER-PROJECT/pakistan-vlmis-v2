...
class WarehouseTypesProxy extends \WarehouseTypes implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'pkId', 'warehouseTypeName', 'resupplyInterval', 'reservedStock', 'usagePercentage', 'geoLevelId', 'listRank', 'createdDate', 'modifiedDate', 'modifiedBy', 'warehouseTypeCategory', 'createdBy');
    }
