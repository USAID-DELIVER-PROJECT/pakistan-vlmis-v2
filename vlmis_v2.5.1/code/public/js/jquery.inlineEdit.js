...
(function($) {
        ...
        $('.editableSingle').click(function() {
            ...
            if (!editableFields || $('.editField').length < editableFields) {
                ...
                if ($('.editFieldFirst').length == 0) {
                    ...
                    $(this).html('<div class="editFieldWrapper"><input type="text" id="datepickeredit" readonly="true" value="' + value + '" class="form-control editField editFieldFirst span2" /></div>');
                    if (!simpleMode) {
    ...
    $.inlineEdit_receive_supplier = function(urls, options) {
        ...
        $('.editableSingle').click(function() {
            ...
            if (!editableFields || $('.editField').length < editableFields) {
                ...
                if ($('.editFieldFirst').length == 0) {
                    editableFields = $(this).siblings('.editableSingle, .editableMulti').length + 1;
                    $(this).html('<div class="editFieldWrapper"><input type="text" value="' + value + '" class="editField editFieldFirst span2" /></div>');
