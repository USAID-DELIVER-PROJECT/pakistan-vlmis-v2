 ...
 */
class CcmAssetTypesProxy extends \CcmAssetTypes implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setAssetTypeName($assetTypeName);
    }

    public function getAssetTypeName()
    {
        $this->__load();
        return parent::getAssetTypeName();
    }
    ...
    {
        return array('__isInitialized__', 'pkId', 'assetTypeName', 'status', 'createdDate', 'modifiedDate', 'parent', 'ccmEquipmentType', 'modifiedBy', 'createdBy');
    }
