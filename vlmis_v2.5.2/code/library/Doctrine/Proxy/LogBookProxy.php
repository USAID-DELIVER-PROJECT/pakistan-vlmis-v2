...
class LogBookProxy extends \LogBook implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setUnionCouncilId($unionCouncilId);
    }

    public function getUnionCouncilId()
    {
        $this->__load();
        return parent::getUnionCouncilId();
    }
    ...
    {
        $this->__load();
        return parent::setReferToWarehouseId($referToWarehouseId);
    }

    public function getReferToWarehouseId()
    {
        $this->__load();
        return parent::getReferToWarehouseId();
    }
    ...
    {
        return array('__isInitialized__', 'pkId', 'name', 'fatherName', 'gender', 'age', 'contact', 'address', 'unionCouncilId', 'vaccinationDate', 'referToWarehouseId', 'remarks', 'createdDate', 'modifiedDate', 'reportingStartDate', 'modifiedBy', 'district', 'warehouse', 'createdBy');
    }
