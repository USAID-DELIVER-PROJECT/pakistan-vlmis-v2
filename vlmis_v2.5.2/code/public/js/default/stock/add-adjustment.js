$(function () {
    ...
    $("#adjustment_type").change(function () {
        ...
        var selectProducts = {};
        selectProducts[13] = "AD Syringe 0.05ml";
        selectProducts[14] = "AD Syringe 0.5ml";
        selectProducts[15] = "Recon. Syr 5ml";
        selectProducts[16] = "Safety Box";
        selectProducts[19] = "Recon. Syr 2ml";
        selectProducts[20] = "DIL-BCG-20";
        selectProducts[21] = "DIL-Measles-10";
        selectProducts[22] = "DIL-Measles-10 (Campaign)";
        selectProducts[39] = "Dropper";

        if (adjustment_type == 6) {
            $.each(selectProducts, function (key, value) {
                $("#product option[value='" + key + "']").remove();
            });
        } else {
            $.each(selectProducts, function (key, value) {
