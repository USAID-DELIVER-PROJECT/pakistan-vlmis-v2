...
$(document).ready(function () {
    ...
    $("#fixed_planned_sessions, #fixed_actually_held_sessions, #outreach_planned_sessions, #outreach_actually_held_sessions, #children_live_birth, #surviving_children_0_11_M, #children_aged_12_23_M, #2_year_above, #pregnant_women1, #cba").focusout(function (e) {
        if ($(this).val() == '' || isNaN($(this).val())) {
            $(this).val('0');
        }
        if ($(this).val() < 0) {
    ...
    $("#fixed_planned_sessions, #fixed_actually_held_sessions, #outreach_planned_sessions, #outreach_actually_held_sessions, #children_live_birth, #surviving_children_0_11_M, #children_aged_12_23_M, 2_year_above, #pregnant_women1, #cba").focus(function (e) {
        var val = $(this).val();
        if (val == 0) {
            $(this).val('');
        }
