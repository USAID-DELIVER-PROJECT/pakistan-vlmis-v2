/*
SQLyog Ultimate
MySQL - 5.7.10-log : Database - vlmisr2
*********************************************************************
*/
...
/*Table structure for table `barcode_scanner_warehouses` */
...
/*Table structure for table `barcode_scanners` */
...
/*Table structure for table `campaign_districts` */
...
/*Table structure for table `campaign_item_pack_sizes` */
...
/*Table structure for table `campaign_lqas_data` */
...
/*Table structure for table `campaign_readiness` */
...
/*Table structure for table `campaign_readiness_union_council` */
...
/*Table structure for table `ccm_asset_types` */
...
/*Table structure for table `ccm_cold_rooms` */
...
/*Table structure for table `ccm_generators` */
...
/*Table structure for table `ccm_history` */
...
) ENGINE=InnoDB AUTO_INCREMENT=56720 DEFAULT CHARSET=latin1;

/*Table structure for table `ccm_human_resources` */
...
/*Table structure for table `ccm_makes` */
...
/*Table structure for table `ccm_models` */
...
/*Table structure for table `ccm_status_history` */
...
) ENGINE=InnoDB AUTO_INCREMENT=99195 DEFAULT CHARSET=latin1;

/*Table structure for table `ccm_status_list` */
...
/*Table structure for table `ccm_transfer_history` */
...
/*Table structure for table `ccm_vehicles` */
...
/*Table structure for table `ccm_voltage_regulators` */
...
/*Table structure for table `ccm_warehouses` */
...
/*Table structure for table `ccm_warehouses_solar_energy` */
...
/*Table structure for table `ccm_warehouses_vaccination_staff` */
...
/*Table structure for table `cold_chain` */
...
/*Table structure for table `epi_amc` */
...
/*Table structure for table `fav_graph_settings` */
...
/*Table structure for table `future_arrivals` */
...
/*Table structure for table `future_arrivals_draft` */
...
/*Table structure for table `gatepass_detail` */
...
/*Table structure for table `gatepass_master` */
...
/*Table structure for table `gatepass_vehicles` */
...
/*Table structure for table `geo_color` */
...
/*Table structure for table `geo_indicator_values` */
...
/*Table structure for table `geo_indicators` */
...
/*Table structure for table `geo_levels` */
...
/*Table structure for table `geo_maps` */
...
/*Table structure for table `hf_data_detail` */
...
) ENGINE=InnoDB AUTO_INCREMENT=2852813 DEFAULT CHARSET=latin1;

/*Table structure for table `hf_data_detail_draft` */
...
) ENGINE=InnoDB AUTO_INCREMENT=20892198 DEFAULT CHARSET=latin1;

/*Table structure for table `hf_data_master` */
...
) ENGINE=InnoDB AUTO_INCREMENT=4105586 DEFAULT CHARSET=utf8;

/*Table structure for table `hf_data_master_draft` */
...
) ENGINE=InnoDB AUTO_INCREMENT=8746498 DEFAULT CHARSET=utf8;

/*Table structure for table `hf_sessions` */
...
) ENGINE=InnoDB AUTO_INCREMENT=9286 DEFAULT CHARSET=latin1;

/*Table structure for table `item_activities` */
...
) ENGINE=InnoDB AUTO_INCREMENT=44 DEFAULT CHARSET=utf8 COMMENT='contain information about product attributes';
...
/*Table structure for table `location_populations` */
...
) ENGINE=InnoDB AUTO_INCREMENT=14765 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=42501 DEFAULT CHARSET=latin1;

/*Table structure for table `log_book_item_doses` */
...
) ENGINE=InnoDB AUTO_INCREMENT=212531 DEFAULT CHARSET=latin1;

/*Table structure for table `map_district_mapping` */
...
/*Table structure for table `mos_scale` */
...
/*Table structure for table `non_ccm_locations` */
...
) ENGINE=InnoDB AUTO_INCREMENT=857 DEFAULT CHARSET=utf8 COMMENT='contains detail information of stakeholder and itm_info_tab';
...
/*Table structure for table `pilot_districts` */
...
/*Table structure for table `pipeline_consignments` */
...
/*Table structure for table `pipeline_consignments_draft` */
...
/*Table structure for table `pipeline_consignments_placements` */
...
) ENGINE=InnoDB AUTO_INCREMENT=20322 DEFAULT CHARSET=latin1;

/*Table structure for table `placement_summary` */
...
) ENGINE=InnoDB AUTO_INCREMENT=261416 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=246544 DEFAULT CHARSET=latin1;

/*Table structure for table `placements_copy` */

DROP TABLE IF EXISTS `placements_copy`;

CREATE TABLE `placements_copy` (
  `pk_id` int(11) NOT NULL AUTO_INCREMENT,
  `quantity` int(11) DEFAULT '0',
  `vvm_stage` int(11) DEFAULT '1',
  `is_placed` int(2) unsigned DEFAULT '1' COMMENT '1 when placed 0 when picked',
  ...
  KEY `placements_ibfk_4` (`modified_by`) USING BTREE,
  KEY `placements_ibfk_6` (`vvm_stage`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=165499 DEFAULT CHARSET=latin1;

/*Table structure for table `purpose_transfer_history` */
...
/*Table structure for table `rack_information` */
...
) ENGINE=InnoDB AUTO_INCREMENT=14283 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8 COMMENT='contain user type information';
...
/*Table structure for table `stakeholder_activities` */
...
/*Table structure for table `stakeholder_item_pack_sizes` */
...
/*Table structure for table `stakeholder_sectors` */
...
) ENGINE=InnoDB AUTO_INCREMENT=94 DEFAULT CHARSET=utf8 COMMENT='contain information about stakeholders';
...
/*Table structure for table `stock_batch_vvm` */
...
/*Table structure for table `stock_batch_vvm_history` */
...
/*Table structure for table `stock_batch_warehouses` */
...
) ENGINE=InnoDB AUTO_INCREMENT=75184 DEFAULT CHARSET=utf8;

/*Table structure for table `stock_batch_warehouses_history` */
...
) ENGINE=InnoDB AUTO_INCREMENT=63920 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=495295 DEFAULT CHARSET=utf8;

/*Table structure for table `stock_detail_history` */
...
) ENGINE=InnoDB AUTO_INCREMENT=759313 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=138943 DEFAULT CHARSET=utf8;

/*Table structure for table `stock_master_history` */
...
) ENGINE=InnoDB AUTO_INCREMENT=190238 DEFAULT CHARSET=utf8;
...
/*Table structure for table `user_click_paths` */
...
) ENGINE=InnoDB AUTO_INCREMENT=2025485 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=170646 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=1808 DEFAULT CHARSET=utf8 COMMENT='contain user information';

/*Table structure for table `vvm_groups` */
...
/*Table structure for table `vvm_stages` */
...
/*Table structure for table `vvm_transfer_history` */
...
/*Table structure for table `vvm_types` */
...
/*Table structure for table `warehouse_population` */
...
/*Table structure for table `warehouse_population_archieve` */
...
/*Table structure for table `warehouse_storage_types` */
...
/*Table structure for table `warehouse_type_categories` */
...
) ENGINE=InnoDB AUTO_INCREMENT=18089 DEFAULT CHARSET=latin1;

/*Table structure for table `warehouse_vaccine_storage_types` */
...
) ENGINE=InnoDB AUTO_INCREMENT=10394 DEFAULT CHARSET=utf8 COMMENT='contain information about warehouse';

/*Table structure for table `warehouses_data` */
...
/*Table structure for table `warehouses_data_draft` */
...
/*Table structure for table `warehouses_service_types` */
...
/*Table structure for table `warehouses_update_history` */
...
) ENGINE=InnoDB AUTO_INCREMENT=115052 DEFAULT CHARSET=latin1;

/* Trigger structure for table `placements` */

DELIMITER $$

/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `Add Placements` */$$

/*!50003 CREATE */ /*!50003 TRIGGER `Add Placements` AFTER INSERT ON `placements` FOR EACH ROW BEGIN
...
/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `Update Placements` */$$

/*!50003 CREATE */ /*!50003 TRIGGER `Update Placements` AFTER UPDATE ON `placements` FOR EACH ROW BEGIN
...
/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `Delete Placements` */$$

/*!50003 CREATE */ /*!50003 TRIGGER `Delete Placements` AFTER DELETE ON `placements` FOR EACH ROW BEGIN
...
/* Trigger structure for table `stock_batch_warehouses` */

DELIMITER $$

/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `Add Stock Batch` */$$

/*!50003 CREATE */ /*!50003 TRIGGER `Add Stock Batch` AFTER INSERT ON `stock_batch_warehouses` FOR EACH ROW BEGIN
...
/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `Update Stock Batch` */$$

/*!50003 CREATE */ /*!50003 TRIGGER `Update Stock Batch` AFTER UPDATE ON `stock_batch_warehouses` FOR EACH ROW BEGIN
...
/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `Delete Stock Batch` */$$

/*!50003 CREATE */ /*!50003 TRIGGER `Delete Stock Batch` BEFORE DELETE ON `stock_batch_warehouses` FOR EACH ROW BEGIN
...
/* Trigger structure for table `stock_detail` */

DELIMITER $$

/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `Add Stock Detail` */$$

/*!50003 CREATE */ /*!50003 TRIGGER `Add Stock Detail` AFTER INSERT ON `stock_detail` FOR EACH ROW BEGIN
...
/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `Update Stock Detail` */$$

/*!50003 CREATE */ /*!50003 TRIGGER `Update Stock Detail` AFTER UPDATE ON `stock_detail` FOR EACH ROW BEGIN
...
/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `Delete Stock Detail` */$$

/*!50003 CREATE */ /*!50003 TRIGGER `Delete Stock Detail` BEFORE DELETE ON `stock_detail` FOR EACH ROW BEGIN
...
/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `Adjust Quantity` */$$

/*!50003 CREATE */ /*!50003 TRIGGER `Adjust Quantity` AFTER DELETE ON `stock_detail` FOR EACH ROW BEGIN
    CALL REPAdjustQty(OLD.stock_batch_warehouse_id);
    CALL AdjustPlacements(OLD.pk_id);
END */$$


DELIMITER ;

/* Trigger structure for table `stock_master` */

DELIMITER $$

/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `Add Stock Master` */$$

/*!50003 CREATE */ /*!50003 TRIGGER `Add Stock Master` AFTER INSERT ON `stock_master` FOR EACH ROW BEGIN
...
/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `Update Stock Master` */$$

/*!50003 CREATE */ /*!50003 TRIGGER `Update Stock Master` AFTER UPDATE ON `stock_master` FOR EACH ROW BEGIN
...
/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `Delete Stock Master` */$$

/*!50003 CREATE */ /*!50003 TRIGGER `Delete Stock Master` BEFORE DELETE ON `stock_master` FOR EACH ROW BEGIN
...
/* Function  structure for function  `AdjustQty` */

/*!50003 DROP FUNCTION IF EXISTS `AdjustQty` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `AdjustQty`(`batchId` int,`whId` int) RETURNS bigint(20)
    DETERMINISTIC
BEGIN 
  -- DECLARE receive INT;
  -- DECLARE issue INT;
...
/* Function  structure for function  `GetIllegalWastageofDistrict` */

/*!50003 DROP FUNCTION IF EXISTS `GetIllegalWastageofDistrict` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `GetIllegalWastageofDistrict`(item_id integer, reporting_date varchar(10),district_id integer,allowable_wastage_rate integer,stakeholderid integer) RETURNS varchar(255) CHARSET latin1
    READS SQL DATA
    DETERMINISTIC
BEGIN 
...
/* Function  structure for function  `getMonthlyRcvQtyWH` */

/*!50003 DROP FUNCTION IF EXISTS `getMonthlyRcvQtyWH` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `getMonthlyRcvQtyWH`(`in_month` int,`in_year` int,`in_item` int,`in_wh` int) RETURNS int(11)
    DETERMINISTIC
BEGIN
...
/* Function  structure for function  `getMosColor` */

/*!50003 DROP FUNCTION IF EXISTS `getMosColor` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `getMosColor`(`in_id` float,`in_itemrec_id` int,`in_stkid` int,`in_lvlid` int) RETURNS varchar(100) CHARSET latin1
    DETERMINISTIC
BEGIN 
...
/* Function  structure for function  `GetPicked` */

/*!50003 DROP FUNCTION IF EXISTS `GetPicked` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `GetPicked`(stock_detail_id integer) RETURNS int(11)
    READS SQL DATA
    DETERMINISTIC
BEGIN
...
/* Function  structure for function  `GetPlaced` */

/*!50003 DROP FUNCTION IF EXISTS `GetPlaced` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `GetPlaced`(stock_detail_id integer) RETURNS int(11)
    READS SQL DATA
    DETERMINISTIC
BEGIN
...
/* Function  structure for function  `getStkItemCount` */

/*!50003 DROP FUNCTION IF EXISTS `getStkItemCount` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `getStkItemCount`(`in_id` int) RETURNS int(11)
    DETERMINISTIC
BEGIN
     DECLARE retval  INTEGER;
   IF (in_id = 0) THEN
...
/* Function  structure for function  `GetUnplacedBatches` */

/*!50003 DROP FUNCTION IF EXISTS `GetUnplacedBatches` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `GetUnplacedBatches`(`item_id` int) RETURNS int(11)
    DETERMINISTIC
BEGIN 
  DECLARE item_id INT;
...
/* Function  structure for function  `GetVacdoses` */

/*!50003 DROP FUNCTION IF EXISTS `GetVacdoses` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `GetVacdoses`(item_id integer) RETURNS int(11)
    READS SQL DATA
    DETERMINISTIC
BEGIN 
...
/* Function  structure for function  `getWarehouseType` */

/*!50003 DROP FUNCTION IF EXISTS `getWarehouseType` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `getWarehouseType`(in_wh INTEGER) RETURNS int(11)
    DETERMINISTIC
BEGIN
...
/* Function  structure for function  `ReceiveStockAtUC` */

/*!50003 DROP FUNCTION IF EXISTS `ReceiveStockAtUC` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `ReceiveStockAtUC`(master_id int, trans_no char(50),batch_id int,bnumber char(50),item_pack_size_id int,wh_id int, countr int) RETURNS int(11)
    DETERMINISTIC
BEGIN
...
/* Function  structure for function  `REPgetAvailabilityRateStr` */

/*!50003 DROP FUNCTION IF EXISTS `REPgetAvailabilityRateStr` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `REPgetAvailabilityRateStr`(`in_type` varchar(8),`in_month` int,`in_year` int,`in_item` varchar(8),`in_WF` varchar(1),`in_stk` int,`in_prov` int,`in_dist` varchar(8)) RETURNS varchar(20) CHARSET latin1
    DETERMINISTIC
BEGIN
...
/* Function  structure for function  `REPgetCB` */

/*!50003 DROP FUNCTION IF EXISTS `REPgetCB` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `REPgetCB`(`in_type` varchar(8),`in_month` int,`in_year` int,`in_item` varchar(20),`in_stk` int,`in_prov` int,`in_dist` varchar(8)) RETURNS double
    DETERMINISTIC
BEGIN
...
/* Function  structure for function  `REPgetCBWHData` */

/*!50003 DROP FUNCTION IF EXISTS `REPgetCBWHData` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `REPgetCBWHData`(in_month INTEGER, in_year INTEGER,  in_item INTEGER, in_wh INTEGER) RETURNS int(20)
    READS SQL DATA
    DETERMINISTIC
BEGIN
	DECLARE retval INTEGER;
...
/* Function  structure for function  `REPgetCB_copy` */

/*!50003 DROP FUNCTION IF EXISTS `REPgetCB_copy` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `REPgetCB_copy`(`in_type` varchar(8),`in_month` int,`in_year` int,`in_item` varchar(20),`in_stk` int,`in_prov` int,`in_dist` varchar(8)) RETURNS double
    DETERMINISTIC
BEGIN
...
/* Function  structure for function  `REPgetConsumption` */

/*!50003 DROP FUNCTION IF EXISTS `REPgetConsumption` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `REPgetConsumption`(`in_month` int,`in_year` int,`in_item` int,`in_stk` int,`in_loc_level` varchar(8),`in_loc` int) RETURNS varchar(10) CHARSET latin1
    DETERMINISTIC
BEGIN
...
/* Function  structure for function  `REPgetConsumptionAVG` */

/*!50003 DROP FUNCTION IF EXISTS `REPgetConsumptionAVG` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `REPgetConsumptionAVG`(`in_type` varchar(8),`in_month` int,`in_year` int,`in_item` varchar(20),`in_stk` varchar(255),`in_prov` int,`in_dist` varchar(8)) RETURNS double
    DETERMINISTIC
BEGIN
...
/* Function  structure for function  `REPgetConsumptionAVGMap` */

/*!50003 DROP FUNCTION IF EXISTS `REPgetConsumptionAVGMap` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `REPgetConsumptionAVGMap`(`in_type` varchar(8),`in_month` int,`in_year` int,`in_item` varchar(20),`in_stk` varchar(255),`in_prov` int,`in_dist` varchar(8)) RETURNS double
    DETERMINISTIC
BEGIN
...
/* Function  structure for function  `REPgetData` */

/*!50003 DROP FUNCTION IF EXISTS `REPgetData` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `REPgetData`(`in_col` varchar(255),`in_rg` varchar(1),`in_type` varchar(8),`in_month` int,`in_year` int,`in_item` int,`in_stk` int,`in_prov` int,`in_dist` varchar(8)) RETURNS varchar(255) CHARSET latin1
    DETERMINISTIC
BEGIN
/*
in_col
...
/* Function  structure for function  `REPgetMapConsumption` */

/*!50003 DROP FUNCTION IF EXISTS `REPgetMapConsumption` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `REPgetMapConsumption`(`in_month` int,`in_year` int,`in_item` int,`in_stk` int,`in_loc_level` varchar(8),`in_loc` int) RETURNS varchar(10) CHARSET latin1
    DETERMINISTIC
BEGIN
...
/* Function  structure for function  `REPgetMapData` */

/*!50003 DROP FUNCTION IF EXISTS `REPgetMapData` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `REPgetMapData`(`in_col` varchar(255),`in_rg` varchar(1),`in_type` varchar(8),`in_month` int,`in_year` int,`in_item` int,`in_stk` int,`in_prov` int,`in_dist` varchar(8)) RETURNS varchar(255) CHARSET latin1
    DETERMINISTIC
BEGIN
/*
in_col
...
/* Function  structure for function  `REPgetMOS` */

/*!50003 DROP FUNCTION IF EXISTS `REPgetMOS` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `REPgetMOS`(`in_type` varchar(8),`in_month` int,`in_year` int,`in_item` varchar(20),`in_stk` int,`in_prov` int,`in_dist` varchar(8)) RETURNS varchar(15) CHARSET latin1
    DETERMINISTIC
BEGIN
...
/* Function  structure for function  `REPgetReportingRateStr` */

/*!50003 DROP FUNCTION IF EXISTS `REPgetReportingRateStr` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `REPgetReportingRateStr`(`in_type` varchar(8),`in_month` int,`in_year` int,`in_item` varchar(8),`in_WF` varchar(8),`in_stk` int,`in_prov` int,`in_dist` varchar(8)) RETURNS varchar(20) CHARSET latin1
    DETERMINISTIC
BEGIN
...
/* Function  structure for function  `REPgetRR` */

/*!50003 DROP FUNCTION IF EXISTS `REPgetRR` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `REPgetRR`(in_lvl VARCHAR(10), in_start_date DATE, in_end_date DATE, in_stk INT, in_item INT, in_loc INT, aggregation INT) RETURNS varchar(300) CHARSET latin1
    DETERMINISTIC
BEGIN
...
/* Function  structure for function  `REPgetRR_copy` */

/*!50003 DROP FUNCTION IF EXISTS `REPgetRR_copy` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `REPgetRR_copy`(in_lvl VARCHAR(10), in_start_date DATE, in_end_date DATE, in_stk INT, in_item INT, in_loc INT, aggregation INT) RETURNS varchar(300) CHARSET latin1
    DETERMINISTIC
BEGIN
...
/* Function  structure for function  `REPgetTotalUCs` */

/*!50003 DROP FUNCTION IF EXISTS `REPgetTotalUCs` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `REPgetTotalUCs`(in_lvl varchar(8), in_loc INT, in_stk INT) RETURNS int(11)
    DETERMINISTIC
BEGIN
...
/* Function  structure for function  `REPgetTransWHData` */

/*!50003 DROP FUNCTION IF EXISTS `REPgetTransWHData` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `REPgetTransWHData`(in_type INTEGER,  in_month INTEGER, in_year INTEGER, in_item VARCHAR(20), in_wh INTEGER) RETURNS double
    READS SQL DATA
    DETERMINISTIC
BEGIN
...
/* Function  structure for function  `REPgetWastage` */

/*!50003 DROP FUNCTION IF EXISTS `REPgetWastage` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `REPgetWastage`(in_lvl VARCHAR(10), in_start_date DATE, in_end_date DATE, in_stk INT, in_item INT, in_loc INT, aggregation INT) RETURNS varchar(300) CHARSET latin1
    DETERMINISTIC
BEGIN
...
/* Function  structure for function  `REPUpdateCapacity` */

/*!50003 DROP FUNCTION IF EXISTS `REPUpdateCapacity` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `REPUpdateCapacity`(in_wh INTEGER) RETURNS int(11)
    READS SQL DATA
    DETERMINISTIC
BEGIN
...
/* Function  structure for function  `REPUpdateCarryForward` */

/*!50003 DROP FUNCTION IF EXISTS `REPUpdateCarryForward` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `REPUpdateCarryForward`(in_rpt_date DATE, in_item INTEGER, in_wh INTEGER) RETURNS int(4)
    READS SQL DATA
    DETERMINISTIC
BEGIN
...
/* Function  structure for function  `REPUpdateData` */

/*!50003 DROP FUNCTION IF EXISTS `REPUpdateData` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `REPUpdateData`(in_month INTEGER, in_year INTEGER, in_item INTEGER, in_wh INTEGER, in_created_by INTEGER) RETURNS int(11)
    READS SQL DATA
    DETERMINISTIC
BEGIN
...
/* Function  structure for function  `REPUpdateDataCampaign` */

/*!50003 DROP FUNCTION IF EXISTS `REPUpdateDataCampaign` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `REPUpdateDataCampaign`(in_date DATE, in_item INTEGER, in_wh INTEGER, in_created_by INTEGER, in_c_id INTEGER) RETURNS int(11)
    READS SQL DATA
    DETERMINISTIC
BEGIN
...
/* Function  structure for function  `REPUpdateRequirement` */

/*!50003 DROP FUNCTION IF EXISTS `REPUpdateRequirement` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `REPUpdateRequirement`(in_wh INTEGER) RETURNS int(11)
    READS SQL DATA
    DETERMINISTIC
BEGIN
...
/* Function  structure for function  `UTILgetLimitParam` */

/*!50003 DROP FUNCTION IF EXISTS `UTILgetLimitParam` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `UTILgetLimitParam`(`in_month` int,`in_year` int) RETURNS int(11)
    DETERMINISTIC
BEGIN 
  DECLARE retval INTEGER;  
...
/* Procedure structure for procedure `AdjustPlacements` */

/*!50003 DROP PROCEDURE IF EXISTS  `AdjustPlacements` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `AdjustPlacements`(stock_detail_id INT)
    READS SQL DATA
    DETERMINISTIC
BEGIN
...
/* Procedure structure for procedure `GetIllegalWastageofDistrict` */

/*!50003 DROP PROCEDURE IF EXISTS  `GetIllegalWastageofDistrict` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `GetIllegalWastageofDistrict`(in_item INT, in_rpt_date DATE, in_location_id INT, in_allowable_wastage_rate FLOAT, in_stakeholder INT)
    DETERMINISTIC
BEGIN
...
/* Procedure structure for procedure `GetIllegalWastageofDistrictHF` */

/*!50003 DROP PROCEDURE IF EXISTS  `GetIllegalWastageofDistrictHF` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `GetIllegalWastageofDistrictHF`(in_item INT, in_rpt_date DATE, in_location_id INT, in_allowable_wastage_rate FLOAT, in_stakeholder INT)
    DETERMINISTIC
BEGIN
...
/* Procedure structure for procedure `PlacementSummary` */

/*!50003 DROP PROCEDURE IF EXISTS  `PlacementSummary` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `PlacementSummary`(locationid INT, batchid INT)
    READS SQL DATA
    DETERMINISTIC
BEGIN
...
/* Procedure structure for procedure `REPAdjustQty` */

/*!50003 DROP PROCEDURE IF EXISTS  `REPAdjustQty` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `REPAdjustQty`(batchId INT)
    READS SQL DATA
    DETERMINISTIC
BEGIN
...
/* Procedure structure for procedure `REPgetAMC` */

/*!50003 DROP PROCEDURE IF EXISTS  `REPgetAMC` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `REPgetAMC`(in_type char(5), in_rpt_date DATE, in_location_id INT, in_item INT, in_stakeholder INT)
    DETERMINISTIC
BEGIN
...
/* Procedure structure for procedure `REPgetAMCHF` */

/*!50003 DROP PROCEDURE IF EXISTS  `REPgetAMCHF` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `REPgetAMCHF`(in_type char(2), in_rpt_date DATE, in_location_id INT, in_item INT, in_stakeholder INT)
    DETERMINISTIC
BEGIN
...
/* Procedure structure for procedure `REPgetAMC_copy` */

/*!50003 DROP PROCEDURE IF EXISTS  `REPgetAMC_copy` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `REPgetAMC_copy`(in_type char(2), in_rpt_date DATE, in_location_id INT, in_item INT, in_stakeholder INT)
    DETERMINISTIC
BEGIN
...
/* Procedure structure for procedure `REPgetCB` */

/*!50003 DROP PROCEDURE IF EXISTS  `REPgetCB` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `REPgetCB`(in_type char(5), in_rpt_date DATE, in_location_id INT, in_item INT, in_stakeholder INT)
    DETERMINISTIC
BEGIN
...
/* Procedure structure for procedure `REPgetCBHF` */

/*!50003 DROP PROCEDURE IF EXISTS  `REPgetCBHF` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `REPgetCBHF`(in_type char(2), in_rpt_date DATE, in_location_id INT, in_item INT, in_stakeholder INT)
    DETERMINISTIC
BEGIN
...
/* Procedure structure for procedure `REPgetConsumption` */

/*!50003 DROP PROCEDURE IF EXISTS  `REPgetConsumption` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `REPgetConsumption`(in_type char(2), in_rpt_date DATE, in_location_id INT, in_item INT, in_stakeholder INT)
    DETERMINISTIC
BEGIN
...
/* Procedure structure for procedure `REPgetConsumptionHF` */

/*!50003 DROP PROCEDURE IF EXISTS  `REPgetConsumptionHF` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `REPgetConsumptionHF`(in_type char(2), in_rpt_date DATE, in_location_id INT, in_item INT, in_stakeholder INT)
    DETERMINISTIC
BEGIN
...
/* Procedure structure for procedure `REPgetData` */

/*!50003 DROP PROCEDURE IF EXISTS  `REPgetData` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `REPgetData`(in_type char(5), in_rpt_date DATE, in_location_id INT, in_item INT, in_stakeholder INT)
    DETERMINISTIC
BEGIN
...
/* Procedure structure for procedure `REPStockBatchHistory` */

/*!50003 DROP PROCEDURE IF EXISTS  `REPStockBatchHistory` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `REPStockBatchHistory`(in_id INT, in_action INT)
    READS SQL DATA
    DETERMINISTIC
BEGIN
...
/* Procedure structure for procedure `REPStockDetailHistory` */

/*!50003 DROP PROCEDURE IF EXISTS  `REPStockDetailHistory` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `REPStockDetailHistory`(in_id INT, in_action INT)
    READS SQL DATA
    DETERMINISTIC
BEGIN
...
/* Procedure structure for procedure `REPStockMasterHistory` */

/*!50003 DROP PROCEDURE IF EXISTS  `REPStockMasterHistory` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `REPStockMasterHistory`(in_id INT, in_action INT)
    READS SQL DATA
    DETERMINISTIC
BEGIN
...
/* Procedure structure for procedure `REPUpdateSummaryDistrict` */

/*!50003 DROP PROCEDURE IF EXISTS  `REPUpdateSummaryDistrict` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `REPUpdateSummaryDistrict`(in_stk INT, in_item INT, in_rpt_date DATETIME, in_loc INT)
    READS SQL DATA
    DETERMINISTIC
BEGIN
...
/* Procedure structure for procedure `REPUpdateSummaryNational` */

/*!50003 DROP PROCEDURE IF EXISTS  `REPUpdateSummaryNational` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `REPUpdateSummaryNational`(in_stk INT, in_item INT, in_rpt_date DATETIME)
    READS SQL DATA
    DETERMINISTIC
BEGIN
...
/* Procedure structure for procedure `REPUpdateSummaryProvince` */

/*!50003 DROP PROCEDURE IF EXISTS  `REPUpdateSummaryProvince` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `REPUpdateSummaryProvince`(in_stk INT, in_item INT, in_rpt_date DATETIME, in_loc INT)
    READS SQL DATA
    DETERMINISTIC
BEGIN
...
/* Procedure structure for procedure `REPUpdateSummaryTehsil` */

/*!50003 DROP PROCEDURE IF EXISTS  `REPUpdateSummaryTehsil` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `REPUpdateSummaryTehsil`(in_stk INT, in_item INT, in_rpt_date DATETIME, in_loc INT)
    READS SQL DATA
    DETERMINISTIC
BEGIN
...
/* Procedure structure for procedure `REPUpdateSummaryUC` */

/*!50003 DROP PROCEDURE IF EXISTS  `REPUpdateSummaryUC` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `REPUpdateSummaryUC`(in_wh_id INTEGER, in_item VARCHAR(10), in_rpt_date DATETIME)
    READS SQL DATA
    DETERMINISTIC
BEGIN
...
/* Procedure structure for procedure `_test_copy` */

/*!50003 DROP PROCEDURE IF EXISTS  `_test_copy` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `_test_copy`(in_type char(2), in_rpt_date DATE, in_location_id INT, in_item INT, in_stakeholder INT)
    DETERMINISTIC
BEGIN
