 ...
 */
class Form_Iadmin_GeoIndicators extends Form_Base {
    ...
    private $_fields = array(
        "geo_indicator_name" => "geo_indicator_name",
...
//        "status" => "Status"
    ...
    private $_hidden = array(
        "geo_indicator_name_hidden" => "geo_indicator_name_hidden",
//        "geo_level_description_hidden" => "geo_level_description_hidden",
        "geo_indicator_id" => "geo_indicator_id"
    );
    private $_list = array(
    );
    ...
    public function init() {
        ...
        foreach ($this->_hidden as $col => $name) {
            switch ($col) {
                ...
                case "geo_indicator_name_hidden":
//                case "geo_level_description_hidden":
                case "geo_indicator_id":
