 ...
 *  Form for Requisition Search
 */
class Form_RequisitionSearch extends Form_Base {
    ...
    private $_list = array(
        ...
        'status' => array('' => 'Select', '1' => 'Draft', '0' => 'Submitted', '2' => 'Approved', '4' => 'UnApproved')
    );
...
//Generate WareHouses Combo
        ...
        $result1 = $warehouse->getToRequisitionWarehouses();
