...
class CcmStatusHistoryProxy extends \CcmStatusHistory implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'pkId', 'temperatureAlarm', 'workingQuantity', 'comments', 'statusDate', 'createdDate', 'modifiedDate', 'utilization', 'ccmAssetType', 'ccm', 'createdBy', 'modifiedBy', 'ccmStatusList', 'reason', 'warehouse');
    }
