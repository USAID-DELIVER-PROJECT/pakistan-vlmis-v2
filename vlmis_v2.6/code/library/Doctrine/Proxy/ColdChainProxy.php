...
class ColdChainProxy extends \ColdChain implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'pkId', 'assetId', 'autoAssetId', 'serialNumber', 'estimateLife', 'workingSince', 'quantity', 'manufactureYear', 'status', 'approvedBy', 'approvedOn', 'createdDate', 'modifiedDate', 'temperatureMonitor', 'ccmStatusHistory', 'ccmAssetType', 'ccmModel', 'source', 'warehouse', 'createdBy', 'modifiedBy');
    }
