 ...
 */
class PlacementLocationsProxy extends \PlacementLocations implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setLocationBarcode($locationBarcode);
    }
    ...
    {
        $this->__load();
        return parent::setCapacityPercentage($capacityPercentage);
    }

    public function getCapacityPercentage()
    {
        $this->__load();
        return parent::getCapacityPercentage();
    }
    ...
    {
        return array('__isInitialized__', 'pkId', 'locationBarcode', 'locationId', 'capacityPercentage', 'createdDate', 'modifiedDate', 'modifiedBy', 'locationType', 'createdBy');
    }
