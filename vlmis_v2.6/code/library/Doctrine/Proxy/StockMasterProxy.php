...
class StockMasterProxy extends \StockMaster implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'pkId', 'transactionDate', 'transactionNumber', 'transactionCounter', 'transactionReference', 'dispatchBy', 'draft', 'comments', 'parentId', 'campaignId', 'createdDate', 'issueFrom', 'issueTo', 'modifiedDate', 'modifiedBy', 'transactionType', 'fromWarehouse', 'toWarehouse', 'stakeholderActivity', 'createdBy');
    }
