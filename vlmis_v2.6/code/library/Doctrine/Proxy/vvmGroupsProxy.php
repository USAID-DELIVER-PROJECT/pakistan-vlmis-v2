...
class VvmGroupsProxy extends \VvmGroups implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setVvmGroupId($vvmGroupId);
    }

    public function getVvmGroupId()
    {
        $this->__load();
        return parent::getVvmGroupId();
    }
    ...
    {
        return array('__isInitialized__', 'pkId', 'vvmGroupId', 'createdDate', 'modifiedDate', 'vvmStage', 'createdBy', 'modifiedBy');
    }
