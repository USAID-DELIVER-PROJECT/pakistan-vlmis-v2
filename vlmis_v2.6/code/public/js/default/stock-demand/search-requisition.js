$(function () {
    $('#date_to').css('position', 'relative');
    $('#date_to').css('zIndex', 3000);
...
$('#print_requisition_search').click(
        function () {
            ...
            window.open('print-requisition-search?grpBy=' + val + '&' + all_arguments, '_blank', 'scrollbars=1,width=860,height=595');
        }
);
